...
{{- else }}
{{- if eq (include "multi-agents.namespace" .) (include "embedding.namespace" .) }}
...
{{- else }}
{{- if eq (include "multi-agents.namespace" .) (include "inference.namespace" .) }}
...
{{/* also considered:
        ...
        # oc -n ai-poc-multi-agents-dev-ats-openpaas-cc exec -it llamastack-rhoai-8 -- cat run.yaml
